...
public class ActividadService {
    ...
    public void inicializarActividadesPredeterminadas() {
        ...
        crearActividadPredeterminada("Tarde de juegos de mesa",
                ...
                TipoActividad.CULTURAL,
                "Biblioteca Pública",
                "Dos Hermanas", 37.2828, -5.9205, 20,
                ahora.plusDays(7));
        ...
        crearActividadPredeterminada("Clase de Zumba",
                ...
                TipoActividad.DEPORTIVA,
                "Gimnasio Central",
                "Alcalá de Guadaíra", 37.3372, -5.8449, 30,
                ahora.plusDays(8));
